...
if(isset($_POST)) {
	...
	$viaggio_destinazione = escapePost('viaggio_destinazione');
	$viaggio_classe = escapePost('viaggio_classe');
	...
	dbExec($query);
	info("aggiornato viaggio id=$viaggio_id destinazione=$viaggio_destinazione classe=$viaggio_classe data_partenza=$viaggio_data_partenza data_rientro=$viaggio_data_rientro', ora_partenza = '$viaggio_ora_partenza', ora_rientro = '$viaggio_ora_rientro ore_richieste=$viaggio_ore_richieste richiesta_fuis=$viaggio_richiesta_fuis");
}
?>