...
if (!programmiPubbliciVisibleForRole('materie', 'genitore')) {
...
$materie = $context ? programmiPubbliciRowsForStudent('materie', $selectedStudentId) : [];
        ...
        <div class="panel-body">
            ...
            <?php else: ?>
                ...
                <?php else: ?>
                    ...
                    <?php echo programmiPubbliciRenderRows($materie, 'materie', $selectedStudentId); ?>
                <?php endif; ?>
            <?php endif; ?>
        </div>
    </div>
