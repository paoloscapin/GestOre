		...
		<ul class="nav navbar-nav top-navbar-nav admin-navbar-nav">
			...
			<li class="dropdown">
				...
				<ul class="dropdown-menu">
					...
					<li><a href="<?php echo $__application_base_path; ?>/admin/classi.php"><span class="glyphicon glyphicon-th-large"></span>&ensp;Classi GestOre</a></li>
					<li><a href="<?php echo $__application_base_path; ?>/admin/dipartimenti.php"><span class="glyphicon glyphicon-list"></span>&ensp;Dipartimenti</a></li>
			...
			<li class="dropdown">
				...
				<ul class="dropdown-menu mastercom-dropdown-menu">
					...
					<li><a href="<?php echo $__application_base_path; ?>/admin/mastercom_docente_insegna_sync.php"><span class="glyphicon glyphicon-link"></span>&ensp;Docenti - classi/materie</a></li>
					<li role="separator" class="divider"></li>
			...
			<li class="dropdown">
				<a href="#" class="btn btn-default btn-purple4 nav-btn dropdown-toggle" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
					<span class="glyphicon glyphicon-calendar"></span>&ensp;Orario scolastico <span class="caret"></span>
				</a>
				<ul class="dropdown-menu">
					<li><a href="<?php echo $__application_base_path; ?>/orario_builder/index.php"><span class="glyphicon glyphicon-dashboard"></span>&ensp;Dashboard</a></li>
					<li><a href="<?php echo $__application_base_path; ?>/orario_builder/scenari.php"><span class="glyphicon glyphicon-duplicate"></span>&ensp;Scenari</a></li>
					<li><a href="<?php echo $__application_base_path; ?>/orario_builder/piani_orario.php"><span class="glyphicon glyphicon-list-alt"></span>&ensp;Piani orario</a></li>
					<li><a href="<?php echo $__application_base_path; ?>/orario_builder/aule.php"><span class="glyphicon glyphicon-blackboard"></span>&ensp;Aule</a></li>
					<li><a href="<?php echo $__application_base_path; ?>/orario_builder/alternanze.php"><span class="glyphicon glyphicon-transfer"></span>&ensp;Alternanze materie</a></li>			
					<li><a href="<?php echo $__application_base_path; ?>/orario_builder/aula_gruppi.php"><span class="glyphicon glyphicon-blackboard"></span>&ensp;Gruppi aule</a></li>	
				</ul>
			</li>
