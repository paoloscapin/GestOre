...
<nav class="navbar navbar-default navbar-fixed-top top-navbar top-navbar-default">
	...
	<?php require_once '../common/header-_logo.php'; ?>
		...
		<ul class="nav navbar-nav top-navbar-nav admin-navbar-nav">
			...
			<li><a href="../segreteria/index.php" class="btn btn-default btn-yellow4 nav-btn" role="button"><span class="glyphicon glyphicon-tower"></span>&ensp;Segr. Docenti </a></li>
			<li><a href="../segrata/index.php" class="btn btn-default btn-teal4 nav-btn" role="button"><span class="glyphicon glyphicon-tower"></span>&ensp;Segr. ATA </a></li>
			...
			<li><a href="../didattica/index.php" class="btn btn-default btn-orange4 nav-btn" role="button"><span class="glyphicon glyphicon-knight"></span>&ensp;Segr. Didattica </a></li>
			<li class="dropdown">
				...
				<ul class="dropdown-menu">
					<li><a href="../admin/materia.php"><span class="glyphicon glyphicon-compressed"></span>&ensp;Materie</a></li>
					<li><a href="../admin/attivita.php"><span class="glyphicon glyphicon-blackboard"></span>&ensp;Tipo Attivita</a></li>
					<li><a href="../admin/fuisAssegnatoTipo.php"><span class="glyphicon glyphicon-list-alt"></span>&ensp;Tipo FuisAssegnato</a></li>
					<li><a href="../admin/annoScolastico.php"><span class="glyphicon glyphicon-calendar"></span>&ensp;Anno Scolastico</a></li>
					<li><a href="../admin/utente.php"><span class="glyphicon glyphicon-user"></span>&ensp;Utente</a></li>
					<li role="separator" class="divider"></li>
					<li><a href="../admin/tickets.php"><span class="glyphicon glyphicon-barcode"></span>&ensp;Biglietti</a></li>
				</ul>
			</li>
			<li><a href="../orario/orario.php" class="btn btn-default btn-lightblue4 nav-btn" role="button"><span class="glyphicon glyphicon-time"></span>&ensp;Orario </a></li>
