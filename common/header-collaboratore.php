 ...
 *  @author     Sebastiano Santini <paolo.scapin@gmail.com>
...
<nav class="navbar navbar-default navbar-fixed-top top-navbar top-navbar-default">
	...
	<?php require_once '../common/header-_logo.php'; ?>
		...
		<?php if(getSettingsValue('config','sportelli', false)) : ?>
			<a href="<?php echo $__application_base_path; ?>/collaboratore/sportello.php" class="btn btn-default navbar-btn btn-orange4" role="button"><span class="glyphicon glyphicon-blackboard"></span>&ensp;Sportelli </a>
		<?php endif; ?>
		</ul>
		...
		<ul class="nav navbar-nav navbar-right top-navbar-nav">
			...
			if (haRuolo('admin')) {
				...
				echo '<a href='.$__application_base_path.'/common/logout.php?base=collaboratore><span class="glyphicon glyphicon-log-out"></span></a>';
			}
			?>
			</li>
		</ul>
