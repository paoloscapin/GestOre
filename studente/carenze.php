...
$query = "
    ...
    WHERE id_anno_scolastico = " . intval($__anno_scolastico_corrente_id) . "
      AND id_studente = " . intval($__studente_id) . "
...
<head>
    ...
    <style>
        ...
        body.carenze-student-page {
            background: #f5f7fb;
        }

        .carenze-student-page .panel-orange4 {
            border: 0;
            border-radius: 8px;
        ...
        .carenze-student-page .panel-heading {
            border: 0;
            padding: 14px 16px;
        }

        .carenze-student-page .panel-body {
            padding: 16px;
            background: #fff;
        }
...
<body class="carenze-student-page">
