...
if (!programmiPubbliciVisibleForRole('materie', 'studente')) {
    redirect('/error/unauthorized.php');
}

$context = programmiPubbliciStudentContext((int)$__studente_id);
$materie = $context ? programmiPubbliciRowsForStudent('materie', (int)$__studente_id) : [];

function programmiPubbliciIsMobile(): bool
{
...
<head>
    ...
    <title>Programmi didattica</title>
</head>
<body class="programmi-pubblici-page">
<?php
if (programmiPubbliciIsMobile()) {
...
<div class="container-fluid">
    <div class="panel panel-lightblue4">
        <div class="panel-heading">
            <span class="glyphicon glyphicon-list-alt"></span>&emsp;Programmi didattica
        </div>
        <div class="panel-body">
            ...
            <?php else: ?>
                ...
                <?php echo programmiPubbliciRenderRows($materie, 'materie', (int)$__studente_id); ?>
            <?php endif; ?>
        </div>
    </div>
</div>
