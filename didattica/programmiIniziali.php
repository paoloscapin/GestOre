...
<head>
    ...
    <title>Programmi Iniziali</title>
...
<body>
    ...
    <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-1 text-center">
                        <span class="glyphicon glyphicon-list-alt"
                            style="margin:5px"></span><br><b>Programmi<br>Iniziali</b>
                    </div>
                    <div class="col-md-1 text-center">
                    ...
                    <div>
                        <div>
                            ...
                            <div class="col-md-2 text-right">
                                <div class="text-center">
                                    <?php
                                    if (getSettingsValue('programmiIniziali', 'docente_puo_inserire', false) || (haRuolo('segreteria-didattica')) || (haRuolo('dirigente'))) {
                                        echo '
                                                                        <label class="col-sm-12 control-label" for="materia">Aggiungi Programma</label>
                                                                        <button class="btn btn-xs btn-lima4" onclick="programmiInizialiGetDetails(-1,&#39;false&#39;,&#39;false&#39;)"><span
                    ...
                    <div class="modal-dialog modal-lg" style="margin:auto;width:%40" role="document">
                        <div class="modal-content">
                            <div class="modal-body">
                                ...
                                <div class=" panel panel-lima4">
                                        <div class="panel-body" style="padding:0px">
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <h4 style="text-align:center">Aggiungi Modulo
                                                        <?php
                                                        if (haRuolo('dirigente') || haRuolo('segreteria-didattica')) {
                                                            echo '
                                                        <button class="btn btn-xs btn-lima4"
                                                        data-toggle="tooltip" data-placement="top" title="Crea un nuovo modulo nel programma iniziale"
                                                            onclick="moduloInizialiGetDetails(-1)"><span style="font-size:14px"
                            ...
                            <div class="panel-footer text-center">
                                ...
                                <button type="button" class="btn btn-primary" onclick="programmiInizialiSave()">Salva</button>
                                ';
                                } else
                                if (haRuolo('docente')) {
                                    if (getSettingsValue('programmiIniziali', 'docente_puo_modificare', false)) {
                        ...
                        <div class="panel panel-orange4">
                            ...
                            <div class="panel-footer text-center">
                                ...
                                if (haRuolo('segreteria-didattica')) {
                                    echo '
                                    <button type="button" class="btn btn-default" data-dismiss="modal">Annulla</button>
                                    <button type="button" class="btn btn-primary" onclick="moduloInizialiSave()">Salva</button>';
                                } else
                                    if (haRuolo('docente')) {
        ...
        <!-- Modal per scegliere la classe da importare -->
        <div class="modal fade" id="modalImportClasse" tabindex="-1" role="dialog" aria-labelledby="modalImportClasseLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title" id="modalImportClasseLabel">Scegli la classe da cui importare il programma iniziale</h4>
                    </div>
                    <div class="modal-body">
                        <select id="classeImportSelect" class="selectpicker" data-style="btn-primary"
                            data-live-search="true" data-width="100%">
                        </select>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-default" data-bs-dismiss="modal">Annulla</button>
                        <button type="button" class="btn btn-success" id="btnConfermaImportClasse">Conferma</button>
                    </div>
                </div>
            </div>
        </div>
    ...
    <!-- Custom JS file -->
    <script type="text/javascript" src="js/iniziali.js?v=<?php echo filemtime(__DIR__ . '/js/iniziali.js'); ?>&a=<?php echo $__anno_scolastico_corrente_id; ?>"></script>
</body>
