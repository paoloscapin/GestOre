...
if(isset($_POST)) {
	...
	//TODO da cancellare nelle versioni future dal DB
	...
	if ($categoria_id != 0) // 
	{
		$categoria = dbGetValue("SELECT nome FROM sportello_categoria WHERE sportello_categoria.id=" . $categoria_id);
	}
	else
	{
		$categoria = "sportello didattico"; // valore di default
	}
