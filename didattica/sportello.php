                ...
                <div class="row">
                    ...
                    <div class="col-md-2">
                        <div class="text-center">
                            <label class="col-sm-3 control-label" for="categoria"
                                style="margin:5px 0px 0px 0px;">Categoria</label>
                    ...
                    <div class="col-md-2">
                        <div class="text-right">
                            ...
                            <div class="col-sm-10"><select id="docente_filtro" name="docente_filtro"
                                    class="docente_filtro selectpicker" data-style="btn-lightblue4"
                                    data-live-search="true" data-noneSelectedText="seleziona..." data-width="70%">
                    ...
                    <div class="col-md-auto text-right">
                        ...
                        <button class="btn btn-xs btn-orange4" onclick="sportelloGetDetails(-1)"><span
        ...
        <div class="panel-body" style="padding:0px;margin:0px">
            ...
            <div class="row" id="riga_iscrizioni_sportelli" style="margin:0px 0px 20px 0px">
                ...
                <div class="col-md-3" style="text-align:center">
                    ...
                    <label id="import_studenti" style="margin:0px 10px 0px 0px;padding:5px;"
                        class="btn btn-xs btn-success"><span class="glyphicon glyphicon-upload"></span><b> ISCRIVI
                            STUDENTI</b><input type="file" id="file_select_students"
                            style="display: none;"></label><label id="numero_studenti"
                        ...
                        <div class="panel-body">
                            <form class="form-horizontal">
                                ...
                                <div class="form-group categoria_selector">
                                    ...
                                    <div class="col-sm-8"><select id="categoria" name="categoria"
                                ...
                                <div class="form-group materia_selector">
                                    ...
                                    <div class="col-sm-8"><select id="materia" name="materia"
