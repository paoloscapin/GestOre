...
<div class="container-fluid">
  <div class="panel panel-yellow4">
    <div class="panel-heading">
      <div class="row">
        <div class="col-md-6">
          <span class="glyphicon glyphicon-folder-open"></span>&ensp;Permessi ATA - Le mie richieste
        </div>
        <div class="col-md-6 text-right">
          <button class="btn btn-xs btn-yellow4" id="btn_new">
        ...
        <div class="panel panel-yellow4">
          ...
          <div class="panel-body">
           <div id="permesso_alert" class="alert alert-danger" style="display:none; margin-bottom:10px;"></div>
            ...
            <div class="row" id="block_ferie_sottotipo" style="display:none;">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <!-- ✅ QUI: periodo possibile dinamico -->
            ...
            <!-- BLOCCO SINGOLO (RECUPERO_ORE / VISITE) -->
            ...
            <!-- FERIE: più intervalli date (NO ore) -->
            <div id="block_ferie_multi" style="display:none;">
              <div class="row">
                ...
                <div class="col-md-6 text-right">
                  <button type="button" class="btn btn-xs btn-default" id="btn_add_ferie">
            ...
            <div id="block_104_multi" style="display:none;">
              <div class="row">
                <div class="col-md-6">
                  <label>Intervalli LEGGE 104 (puoi aggiungere più righe: GIORNI o ORE)</label>
                </div>
                <div class="col-md-6 text-right">
                  <button type="button" class="btn btn-xs btn-default" id="btn_add_104">
          ...
          <div class="panel-footer text-center">
            ...
            <button type="button" class="btn btn-success" id="btn_invia">Invia</button>
